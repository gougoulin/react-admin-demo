    ...
    <div className="app-container">
      <aside className="aside">
        <div className="logo">
          ...
          <h3 className="logo-title">User Name</h3>
        </div>
      ...
      <div className="content">
        <header className="header">
          <h3 className="header-title">Home Page</h3>
        </header>
        <div className="main">
          <div className="main-pwd">pwd/pwd/pwd</div>
          <div className="main-inner">
            ...
            <div className="description">
              <div className="card__L">description 1</div>
              <div className="card__L">description 1</div>
              <div className="card__L">description 1</div>
            </div>
            <div className="card__xl">long card</div>
          </div>
        </div>
      </div>
    </div>
